<!-- One logical change per pull request. Small is easier to review and easier to revert. -->

**What this changes and why:**

**Hardware and software it was tested on** (model, firmware, kernel, driver; or "docs only"):

**Checklist**

- [ ] Every hardware claim is tied to a run I did, and the log or measurement is attached or committed.
- [ ] Anything I could not test is labelled as untested, not implied to work.
