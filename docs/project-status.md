...
| Ripper/encoder upstream campaign | **ALL 7 TARGETS ENGAGED** — HandBrake merged PR #8100 (`b0145ad`, x264 frame-packing SEI, 2026-09-16, closes their #5826); posted: StaxRip #1873, x265 #970, ffmpeg [#24530](https://code.ffmpeg.org/FFmpeg/FFmpeg/issues/24530) (bug) + [#24531](https://code.ffmpeg.org/FFmpeg/FFmpeg/issues/24531) (bsf feature), BD3D2MK3D videohelp [post #2803756](https://forum.videohelp.com/threads/395498-BD3D2MK3D-Convert-3D-BDs-or-MKV-to-3D-SBS-TAB-or-FS-MKV-Support-thread/page21#post2803756) (cleared moderation 2026-09-16); mkvmerge ask skipped by owner decision (Codeberg signup paywall — draft retained) | `tools/serviio/upstream-3d-issues/` |
