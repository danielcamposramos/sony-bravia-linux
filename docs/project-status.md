...
| Ripper/encoder upstream campaign | **FIRST TARGET LANDED** — HandBrake merged PR #8100 (`b0145ad`, x264 frame-packing SEI, 2026-09-16, closes their #5826); posted: StaxRip #1873, x265 #970, ffmpeg [#24530](https://code.ffmpeg.org/FFmpeg/FFmpeg/issues/24530) (bug) + [#24531](https://code.ffmpeg.org/FFmpeg/FFmpeg/issues/24531) (bsf feature); mkvmerge ask skipped by owner decision (Codeberg signup paywall — draft retained); remaining: BD3D2MK3D forum post | `tools/serviio/upstream-3d-issues/` |
