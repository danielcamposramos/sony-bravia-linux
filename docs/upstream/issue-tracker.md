...
| 12 | NVIDIA unified EDID-surface issue (3D absent + 10v12 deep colour + 17/51 prune; HDR adjacency; cites #1348, #1369, #1184, HDR trio, #1101) | github.com/NVIDIA/open-gpu-kernel-modules (new issue) | not yet filed; draft `docs/upstream/nvidia-edid-surface-issue-draft.md` | drafted in Daniel's voice 2026-09-22 (one fill-in: GPU model); awaits his edit pass and explicit per-act post approval | Daniel | none until he posts it |
