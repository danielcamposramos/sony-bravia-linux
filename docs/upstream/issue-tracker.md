...
| 13 | nouveau HDMI Deep Color series (3 patches + cover; RGB-only, YCbCr declared as the next series, HDR-might-benefit scope wording) | dri-devel + nouveau lists, lore.kernel.org/dri-devel | cover **<20260922192132.114546-1-Capitain_Jack@yahoo.com>** (patches -2/-3/-4 same base); series files in `/K3D/temp/dual-upstream-preserve-2026-09-22/nouveau-deep-color-series-v2/`; run-5 evidence = `tools/stereo-modeset/run23-*-pass-2026-09-22.log` | **SENT 2026-09-22 16:21 -03** by git send-email (Yahoo SMTP, all four 250), to dri-devel, cc nouveau + lyude@redhat.com + dakr@kernel.org; checkpatch 0/0, built clean on its drm-misc-next base (`73ef663c`+3, `a7315e24` tip), hardware-verified 12-bpc on GA106→KDL-46HX855 | **nouveau maintainers (Lyude, Danilo)** | lore thread + Daniel's subscribed inbox; email-trigger only |
