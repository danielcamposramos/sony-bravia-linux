...
- **Provenance note:** a Claude Opus senior review was commissioned first but was refused twice by the provider's real-time cyber safeguards (owner-hardware right-to-repair study, no third-party devices, public 15-year-old CVE — flagged anyway; request IDs req_011Cf1rq6yagqL6JWpNk9Cvq, req_011Cf1s3seGHbzeKoavo12Q6). Kimi K3 was substituted as senior partner per project owner's decision. A GPT Astra (gpt-6-astra, reasoning high) consult was chained after this review; see `partner-review-presto-astra.md` when it lands.
