...
**Passagem de estilo já aplicada (2026-09-17):** os 24 travessões do corpo
foram tratados segundo o padrão que você usou no ensaio do slop — em prosa
viram vírgula, dois-pontos ou quebra de frase; a pilha de números virou
linhas soltas em negrito em vez de lista com travessão; e os parágrafos
mais densos foram quebrados em uma frase por linha. **Restaram zero
travessões no corpo.** Se quiser algum de volta, as posições que você
preserva são: item de lista curto como separador de definição, atribuição
de citação, e o aforismo de fechamento.
