...
| VLC | **[MR !10366](https://code.videolan.org/videolan/vlc/-/merge_requests/10366) open 2026-09-22** — derives x264 frame-packing from the input layout so transcoding no longer drops the SEI. Submitted in the owner's words after account approval; connects [issue #29582](https://code.videolan.org/videolan/vlc/-/issues/29582), the measured hardware fleet, standards citations and the full upstream repair arc. robUx4 was directly asked to review |
