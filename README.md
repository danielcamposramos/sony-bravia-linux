...
| Piece | Live | Snapshot |
|---|---|---|
| Consumer Rights Wiki (FULU) — product-line page with the incidents and their sources; updated twice on 2026-09-18: first with the five archived end-of-service notices, the browser-3D incident, the Brazil consumer-code section and the corrected firmware claim; then with the 3D still-photograph incident (five archived Sony sources that contradict each other across regions) and an independent second-server reproduction of the DLNA 3D defect | — |
